				    ...
				    WsNotSupportErr: "Ошибка! Ваш браузер не поддерживает работу с web-сокетами!",
					  ...
					  AutoReconnect: "попытка восстановления соединения...",
					     ConnStates: ["подключение...", "подключено", "отключение...", "отключено", "отключено"],
					           None: "---",
								 K1: "К1: ДЭН-200",
								 K2: "К2: HITACHI DSP-75",
								 K3: "К3: HITACHI DSP-75",
								 K4: "К4: HITACHI DSP-75",
							   Sens: {TSt:"Темп. статора", TPd:"Темп. подшипника", TOil:"Темп. масла", PAir:"Давл. воздуха", FlAir:"Фильтр воздуха", LvOil:"Уровень масла"},
