...
//* WebSocket Server
var G_WS_SERVER_URI	    	= "ws://at09.myddns.me:18101";
var G_WS_SERVER_ID	    	= "WsLogWater";
	...
	if(typeof NodeIn == "object" && typeof ValueIn == "number" && typeof DataKeyIn == "string")
	{
		if(NodeIn && DataKeyIn.length)
		{
			if(typeof G_RES[G_LANG][DataKeyIn] != "undefined")
			{
				...
				var LogMessage = ((typeof G_RES[G_LANG][DataKeyIn][ValueIn] == "string") ? G_RES[G_LANG][DataKeyIn][ValueIn] : null);
...
function initUI()
{
	...
	{
		G_HMI = new HMI();
		G_HMI["Options"] = {   Pr1Hi: { DataKey:"WsDI01", Type:"BitLamp", AndMask:16, RiseEdge:true, BitFunc:onBitFuncWsGreenLog },
							   Pr1Mi: { DataKey:"WsDI01", Type:"BitLamp", AndMask:4, RiseEdge:true, BitFunc:onBitFuncWsLog },
							   Pr1Lo: { DataKey:"WsDI01", Type:"BitLamp", AndMask:1, RiseEdge:true, BitFunc:onBitFuncWsYellowLog },
							  Lv1Src: { DataKey:"Lv1", Type:"ArrayIDx", Arr:G_RES[G_LANG]["LvSrc"], NodeAttr:"src", DefaultValue:"images/lv-no.png", NodeID:"Lv1" },
							     Lv1: { DataKey:"Lv1", Type:"BitLamp" },
							     Al1: { DataKey:"WsSt", Type:"BitLampBlink", Bit:3 },
							      T1: { DataKey:"T1", Type:"Number", Offset:1, Round:1 },
							   Pr2Hi: { DataKey:"WsDI01", Type:"BitLamp", AndMask:32, RiseEdge:true, BitFunc:onBitFuncWsGreenLog },
							   Pr2Mi: { DataKey:"WsDI01", Type:"BitLamp", AndMask:8, RiseEdge:true, BitFunc:onBitFuncWsLog },
							   Pr2Lo: { DataKey:"WsDI01", Type:"BitLamp", AndMask:2, RiseEdge:true, BitFunc:onBitFuncWsYellowLog },
							  Lv2Src: { DataKey:"Lv2", Type:"ArrayIDx", Arr:G_RES[G_LANG]["LvSrc"], NodeAttr:"src", DefaultValue:"images/lv-no.png", NodeID:"Lv2" },
							     Lv2: { DataKey:"Lv2", Type:"BitLamp" },
							     Al2: { DataKey:"WsSt", Type:"BitLampBlink", Bit:4 },
							      T2: { DataKey:"T2", Type:"Number", Offset:1, Round:1 },
							  	 Pm1: { DataKey:"WsDI01", Type:"BitLamp", Bit:7, RiseEdge:true, Func:onBitFuncWsLog },
							  	 Pi1: { DataKey:"WsDI01", Type:"BitLamp", Bit:7 },
							  	 Pm2: { DataKey:"WsDI01", Type:"BitLamp", Bit:8, RiseEdge:true, Func:onBitFuncWsLog },
							  	 Pi2: { DataKey:"WsDI01", Type:"BitLamp", Bit:8 },
						         Plс: { DataKey:"Plc", Type:"String" },
							  WsSt_1: { DataKey:"WsSt", Type:"BitFunc", AndMask:2, RiseEdge:true, BitFunc:onBitFuncWsRedLog, NodeID:"Lv1" },
							  WsSt_2: { DataKey:"WsSt", Type:"BitFunc", AndMask:4, RiseEdge:true, BitFunc:onBitFuncWsRedLog, NodeID:"Lv2" },
						   WsErNet_0: { DataKey:"WsErNet", Type:"BitFunc", AndMask:1, RiseEdge:true, BitFunc:onBitFuncWsRedLog, NodeID:"Plс" },
						   WsErNet_1: { DataKey:"WsErNet", Type:"BitFunc", AndMask:2, RiseEdge:true, BitFunc:onBitFuncWsRedLog, NodeID:"Plс" },
						   WsErNet_2: { DataKey:"WsErNet", Type:"BitFunc", AndMask:4, RiseEdge:true, BitFunc:onBitFuncWsRedLog, NodeID:"Plс" },
						  WsErSens_0: { DataKey:"WsErSens", Type:"BitFunc", AndMask:1, RiseEdge:true, BitFunc:onBitFuncWsRedLog, NodeID:"Lv1" },
						  WsErSens_1: { DataKey:"WsErSens", Type:"BitFunc", AndMask:2, RiseEdge:true, BitFunc:onBitFuncWsRedLog, NodeID:"Lv2" }
							};
