...
//* WebSocket Server
var G_WS_SERVER_URI	    	= "ws://at09.myddns.me:18104";
var G_WS_SERVER_ID	    	= "WsLogBoil";
...
function initUI()
{
	...
	{
		G_HMI = new HMI();
		G_HMI["Options"] = {  Tset1: { DataKey:"Tset1", Type:"Number", Offset:10, Round:1 },
							  Pset1: { DataKey:"Pset1", Type:"Number", Offset:10, Round:1 },
							  Tret1: { DataKey:"Tret1", Type:"Number", Offset:10, Round:1 },
							  Pret1: { DataKey:"Pret1", Type:"Number", Offset:10, Round:1 },
							  Tloc1: { DataKey:"Tloc1", Type:"Number", Offset:10, Round:1 },
							    St1: { DataKey:"St1", Type: "ArrayIDx", Arr: G_RES[G_LANG]["StArr"] },
							  Tset2: { DataKey:"Tset2", Type:"Number", Offset:10, Round:1 },
							  Pset2: { DataKey:"Pset2", Type:"Number", Offset:10, Round:1 },
							  Tret2: { DataKey:"Tret2", Type:"Number", Offset:10, Round:1 },
							  Pret2: { DataKey:"Pret2", Type:"Number", Offset:10, Round:1 },
							  Tloc2: { DataKey:"Tloc2", Type:"Number", Offset:10, Round:1 },
							    St2: { DataKey:"St2", Type: "ArrayIDx", Arr: G_RES[G_LANG]["StArr"] },
							  Tset3: { DataKey:"Tset3", Type:"Number", Offset:10, Round:1 },
							  Pset3: { DataKey:"Pset3", Type:"Number", Offset:10, Round:1 },
							  Tret3: { DataKey:"Tret3", Type:"Number", Offset:10, Round:1 },
							  Pret3: { DataKey:"Pret3", Type:"Number", Offset:10, Round:1 },
							  Tloc3: { DataKey:"Tloc3", Type:"Number", Offset:10, Round:1 },
							    St3: { DataKey:"St3", Type: "ArrayIDx", Arr: G_RES[G_LANG]["StArr"] },
							 Tcont3: { DataKey:"Tcont3", Type:"Number", Offset:10, Round:1 },
							TsetHw3: { DataKey:"TsetHw3", Type:"Number", Offset:10, Round:1 },
							TretHw3: { DataKey:"TretHw3", Type:"Number", Offset:10, Round:1 },
							   Pcw3: { DataKey:"Pcw3", Type:"Number", Offset:10, Round:1 }
							};
