...
//* WebSocket Server
var G_WS_SERVER_URI	    	= "ws://at09.myddns.me:18105";
var G_WS_SERVER_ID	    	= "WsLogBoil1";
	...
	if(typeof HMI == "function")
	{
		...
		G_HMI["Options"] = {  Y1Al: { DataKey:"WsDI", Type:"BitLampBlink", Bit:9, Inverted:true },
		                     ...
		                     PwrSt: { DataKey:"WsDI", Type:"BitLamp", Bit:8 },
							  ...
							  Pres: { DataKey:"Pres", Type:"Number", Offset:10, Round:1 },
							  Pret: { DataKey:"Pret", Type:"Number", Offset:10, Round:1 },
							  Pext: { DataKey:"Pext", Type:"Number", Offset:10, Round:1 },
							  Tres: { DataKey:"Tres", Type:"Number", Offset:10, Round:1 },
