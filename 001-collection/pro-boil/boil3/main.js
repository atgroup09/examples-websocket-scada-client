...
//* WebSocket Server
var G_WS_SERVER_URI	    	= "ws://at09.myddns.me:18107";
var G_WS_SERVER_ID	    	= "WsLogBoil3";
...
function initUI()
{
	...
	{
		G_HMI = new HMI();
		G_HMI["Options"] = {  Y1Al: { DataKey:"WsDI", Type:"BitLampBlink", Bit:9, Inverted:true },
		                      Y1St: { DataKey:"WsDI", Type:"BitLamp", Bit:9 },
							 PwrAl: { DataKey:"WsDI", Type:"BitLampBlink", Bit:8, Inverted:true },
		                     PwrSt: { DataKey:"WsDI", Type:"BitLamp", Bit:8 },
							  B1Al: { DataKey:"WsDI", Type:"BitLampBlink", AndMask:21, Not:true },
							  B1St: { DataKey:"WsDI", Type:"BitLamp", Bit:0 },
							  B1Fi: { DataKey:"WsDI", Type:"BitLamp", Bit:2 },
							  B2Al: { DataKey:"WsDI", Type:"BitLampBlink", AndMask:42, Not:true },
							  B2St: { DataKey:"WsDI", Type:"BitLamp", Bit:1 },
							  B2Fi: { DataKey:"WsDI", Type:"BitLamp", Bit:3 },
							  H1St: { DataKey:"WsDI", Type:"BitLamp", Bit:6 },
							  H2St: { DataKey:"WsDI", Type:"BitLamp", Bit:7 },
							  H3St: { DataKey:"WsDI", Type:"BitLamp", Bit:10 },
							  H4St: { DataKey:"WsDI", Type:"BitLamp", Bit:11 },
							  Pset: { DataKey:"Pset", Type:"Number", Offset:10, Round:1 },
							  Tset: { DataKey:"Tset", Type:"Number", Offset:10, Round:1 },
							  Pret: { DataKey:"Pret", Type:"Number", Offset:10, Round:1 },
							  Tret: { DataKey:"Tret", Type:"Number", Offset:10, Round:1 },
							   Pcw: { DataKey:"Pcw", Type:"Number", Offset:10, Round:1 },
						    TsetHw: { DataKey:"TsetHw", Type:"Number", Offset:10, Round:1 },
						    TretHw: { DataKey:"TretHw", Type:"Number", Offset:10, Round:1 },
						     Tcont: { DataKey:"Tcont", Type:"Number", Offset:10, Round:1 },
							  Tloc: { DataKey:"Tloc", Type:"Number", Offset:10, Round:1 },
							  Tout: { DataKey:"Tout", Type:"Number", Offset:10, Round:1 },
						  //PwrOnLog: { DataKey:"WsDI", Type:"BitFunc", AndMask:256, BoolNum:true, RiseEdge:true, BitFunc:onBitFuncWsGreenLog, NodeID:"PwrSt" },
						 PwrOffLog: { DataKey:"WsDI", Type:"BitFunc", AndMask:256, BoolNum:true, RiseEdge:true, BitFunc:onBitFuncWsRedLog, NodeID:"PwrAl", Not:true },
						   //Y1OnLog: { DataKey:"WsDI", Type:"BitFunc", AndMask:512, BoolNum:true, RiseEdge:true, BitFunc:onBitFuncWsGreenLog, NodeID:"Y1St" },
						  Y1OffLog: { DataKey:"WsDI", Type:"BitFunc", AndMask:512, BoolNum:true, RiseEdge:true, BitFunc:onBitFuncWsRedLog, NodeID:"Y1Al", Not:true },
						  //Ps1OkLog: { DataKey:"WsDI", Type:"BitFunc", AndMask:16, BoolNum:true, RiseEdge:true, BitFunc:onBitFuncWsGreenLog, NodeID:"Ps1St" },
					      Ps1AlLog: { DataKey:"WsDI", Type:"BitFunc", AndMask:16, BoolNum:true, RiseEdge:true, BitFunc:onBitFuncWsRedLog, NodeID:"Ps1Al", Not:true },
						  //Ps2OkLog: { DataKey:"WsDI", Type:"BitFunc", AndMask:32, BoolNum:true, RiseEdge:true, BitFunc:onBitFuncWsGreenLog, NodeID:"Ps2St" },
						  Ps2AlLog: { DataKey:"WsDI", Type:"BitFunc", AndMask:32, BoolNum:true, RiseEdge:true, BitFunc:onBitFuncWsRedLog, NodeID:"Ps2Al", Not:true },
						   //B1OkLog: { DataKey:"WsDI", Type:"BitFunc", AndMask:1, BoolNum:true, RiseEdge:true, BitFunc:onBitFuncWsGreenLog, NodeID:"B1St" },
						   B1AlLog: { DataKey:"WsDI", Type:"BitFunc", AndMask:1, BoolNum:true, RiseEdge:true, BitFunc:onBitFuncWsRedLog, NodeID:"B1Al", Not:true },
						   //B2OkLog: { DataKey:"WsDI", Type:"BitFunc", AndMask:2, BoolNum:true, RiseEdge:true, BitFunc:onBitFuncWsGreenLog, NodeID:"B2St" },
						   B2AlLog: { DataKey:"WsDI", Type:"BitFunc", AndMask:2, BoolNum:true, RiseEdge:true, BitFunc:onBitFuncWsRedLog, NodeID:"B2Al", Not:true },
						  Fi1AlLog: { DataKey:"WsDI", Type:"BitFunc", AndMask:4, BoolNum:true, RiseEdge:true, BitFunc:onBitFuncWsRedLog, NodeID:"B1Fi", Not:true },
						  Fi2AlLog: { DataKey:"WsDI", Type:"BitFunc", AndMask:8, BoolNum:true, RiseEdge:true, BitFunc:onBitFuncWsRedLog, NodeID:"B2Fi", Not:true }
							};
